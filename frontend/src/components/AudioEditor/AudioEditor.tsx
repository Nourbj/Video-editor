...
export default function AudioEditor() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-white mb-1">Audio</h2>
        <p className="text-sm text-zinc-400">Add background music or replace the original audio</p>
      </div>
      ...
      {!audioTrack ? (
        <div
          ...
          className="border-2 border-dashed border-zinc-700 hover:border-zinc-500 rounded-2xl p-8 text-center cursor-pointer transition-all hover:bg-zinc-800/40"
        >
          <input
            ref={fileRef}
            type="file"
          ...
          <p className="text-zinc-300 font-medium">Upload audio track</p>
        ...
        <div className="bg-zinc-800/60 rounded-xl p-4 space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-white">{audioTrack.filename}</p>
